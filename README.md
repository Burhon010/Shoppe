...
- **Нет фото товаров** — `image: null` в `src/data/products.js`, `ProductCard`/`Gallery` показывают плейсхолдер. Экспортируй фото из Figma в `src/assets/images` и подставь пути.
